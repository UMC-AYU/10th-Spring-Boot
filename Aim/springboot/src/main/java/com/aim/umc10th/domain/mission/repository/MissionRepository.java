...
public interface MissionRepository extends JpaRepository<Mission, Long> {
    ...
    @Query("SELECT m FROM Mission m JOIN m.store s JOIN s.region r WHERE r.name = :regionName")
    Page<Mission> findAllByStoreRegionName(@Param("regionName") String regionName, Pageable pageable);
}
